      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <Link href="/" className="inline-block">
            <h1 className="text-2xl font-bold text-primary">AskMeNow</h1>
        ...
        <Card className="px-4 shadow-md border-border/10">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-center">
              ...
              <Link
                href="/register"
                className="ml-1 font-medium transition-colors text-primary hover:text-primary/80"
              >
                Sign up
              </Link>
            </div>
